...
class TestCleaning(unittest.TestCase):
    ...
    def test_clean_valid_data(self):
        ...
        self.assertEqual("hybrid", vehicles["driving_force"][0])
        self.assertEqual("Toyota", vehicles["maker"][0])
        self.assertEqual(5000, vehicles["mileage"][0])
        ...
        self.assertEqual("diesel", vehicles["driving_force"][1])
        self.assertEqual("Ford", vehicles["maker"][1])
        self.assertEqual(10000, vehicles["mileage"][1])
        ...
        self.assertEqual("electricity", vehicles["driving_force"][3])
        self.assertEqual("Volkswagen", vehicles["maker"][3])
        self.assertEqual(12000, vehicles["mileage"][3])
        ...
        self.assertEqual("other", vehicles["driving_force"][4])
        self.assertEqual("Other", vehicles["maker"][4])
        self.assertEqual(1500, vehicles["mileage"][4])
        ...
        self.assertEqual(80000, vehicles["mileage"][5])
